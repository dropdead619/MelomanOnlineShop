// SMSC.KZ API (smsc.kz) версия 3.1 (03.07.2019)
using System;
using System.Web;
using System.Net;
using System.IO;
...
public class SMSC
{
	...
	const string SMSC_LOGIN = "nikita.boltushkin";		    // логин клиента
	const string SMSC_PASSWORD = "qwerty123456";	// пароль или MD5-хеш пароля в нижнем регистре
	...
	const string SMTP_FROM = "api@smsc.kz";		// e-mail адрес отправителя
 ...
 //       }
	...
	private string[] _smsc_send_cmd(string cmd, string arg, string[] files = null)
	{
		...
		url = _url = (SMSC_HTTPS ? "https" : "http") + "://smsc.kz/sys/" + cmd + ".php" + (SMSC_POST ? "" : "?" + arg);
        ...
        {
            if (i++ > 0)
                url = _url.Replace("smsc.kz/", "www" + i.ToString() + ".smsc.kz/");
